...
TABLES['fkConjuntoPessoa_Acervo'] = ('''
      ALTER TABLE `conjunto_pessoa` ADD CONSTRAINT `fkConjuntoPessoa_Acervo` FOREIGN KEY (`idConjunto`) 
      REFERENCES `acervo` (`idAcervo`);''')
...
#usuario_sql = 'INSERT INTO usuario (idUsuario, idAcervo, apelido, nome, senha, tpUsuario, email, telefone, contatoPublico, alterarSenha, redesSociais, dtInclusao) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)'
#usuario = [
#      (1, 0, 'casoba', 'Carlos Alberto Romanelli', '12345678', 'M', 'emaildoroma@gmail.com', '(32)98857-2905', 'N', 'N', 'Instagram: @romanelli.carlos', '2023-07-24')
#]
...
#tipo_sql = 'INSERT INTO tipo_variacao (idTipoVariacao, idAcervo, descricao) VALUES (%s, %s, %s)'
#tipos = [
#      (1, 0, 'Original'),
#      (2, 0, 'Arranjo'),
#      (3, 0, 'Transcrição'),
